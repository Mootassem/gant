...
export default class TransactionService {
  ...
  async create(data) {
    ...
    try {
      data.email = await UserRepository.filterIdInTenant(data.email, { ...this.options, session });
      data.tax = await TaxesRepository.filterIdInTenant(data.tax, { ...this.options, session });
      data.orderId = await OrderRepository.filterIdsInTenant(data.orderId, { ...this.options, session });
