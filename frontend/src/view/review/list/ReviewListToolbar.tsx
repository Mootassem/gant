...
import reviewSelectors from 'src/modules/review/reviewSelectors';
import destroyActions from 'src/modules/review/destroy/reviewDestroyActions';
import destroySelectors from 'src/modules/review/destroy/reviewDestroySelectors';
...
function ReviewToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    reviewSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    reviewSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    reviewSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="review-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="review-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="review-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="review-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=review">
          <span
