...
function ObjectifToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    objectifSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    objectifSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="objectif-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="objectif-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="objectif-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="objectif-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
...
export default ObjectifToolbar;
