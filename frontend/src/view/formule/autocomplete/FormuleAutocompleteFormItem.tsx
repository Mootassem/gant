...
import FormuleFormModal from 'src/view/formule/form/FormuleFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/formule/formuleSelectors';

function FormuleAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return FormuleService.listAutocomplete(value, limit);
  };
...
export default FormuleAutocompleteFormItem;
