...
function CartToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    cartSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    cartSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="cart-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="cart-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="cart-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="cart-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=cart">
