...
function TypeRevenueListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    typeRevenueSelectors.selectPermissionToEdit,
  );
...
export default TypeRevenueListTable;
