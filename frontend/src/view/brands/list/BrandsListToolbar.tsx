...
function BrandsToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    brandsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    brandsSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="brands-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="brands-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="brands-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="brands-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=brands">
          <span
