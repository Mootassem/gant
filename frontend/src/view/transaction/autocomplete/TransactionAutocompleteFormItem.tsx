...
import TransactionFormModal from 'src/view/transaction/form/TransactionFormModal';
...
function TransactionAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return TransactionService.listAutocomplete(value, limit);
  };
