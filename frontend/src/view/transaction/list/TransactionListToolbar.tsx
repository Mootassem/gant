...
function TransactionToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    transactionSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    transactionSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="transaction-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="transaction-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="transaction-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="transaction-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=transaction">
          <span
