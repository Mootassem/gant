...
import selectors from 'src/modules/paymentsettings/form/paymentsettingsFormSelectors';
...
function PaymentsettingsFormPage(props) {
  ...
  const title = isEditing
    ? i18n('entities.paymentsettings.edit.title')
      ...
      <ContentWrapper>
        ...
        {dispatched && !initLoading && (
          <PaymentsettingsForm
            ...
            isEditing={isEditing}
            onSubmit={doSubmit}
            onCancel={() => getHistory().push('/paymentsettings')}
          />
        )}
      </ContentWrapper>
    </>
...
export default PaymentsettingsFormPage;
