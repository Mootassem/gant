...
function TypeChargeListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    typeChargeSelectors.selectPermissionToEdit,
  );
...
export default TypeChargeListTable;
