...
function SubcategoriesViewToolbar(props) {
  ...
  const hasPermissionToEdit = useSelector(
    subcategoriesSelectors.selectPermissionToEdit,
  );
...
export default SubcategoriesViewToolbar;
