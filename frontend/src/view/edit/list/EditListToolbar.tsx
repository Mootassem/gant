...
import editSelectors from 'src/modules/edit/editSelectors';
import destroyActions from 'src/modules/edit/destroy/editDestroyActions';
import destroySelectors from 'src/modules/edit/destroy/editDestroySelectors';
...
function EditToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    editSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    editSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    editSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="edit-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="edit-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="edit-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="edit-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=edit">
          <span
