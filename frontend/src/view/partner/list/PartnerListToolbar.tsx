...
function PartnerToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    partnerSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    partnerSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="partner-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="partner-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="partner-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="partner-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=partner">
          <span
