...
function TypeProjetToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    typeProjetSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    typeProjetSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="type-projet-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="type-projet-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="type-projet-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="type-projet-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=typeProjet">
...
export default TypeProjetToolbar;
