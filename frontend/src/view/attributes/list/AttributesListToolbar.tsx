...
import attributesSelectors from 'src/modules/attributes/attributesSelectors';
import destroyActions from 'src/modules/attributes/destroy/attributesDestroyActions';
import destroySelectors from 'src/modules/attributes/destroy/attributesDestroySelectors';
import actions from 'src/modules/attributes/list/attributesListActions';
...
function AttributesToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    attributesSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    attributesSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    attributesSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="attributes-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="attributes-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="attributes-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="attributes-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
