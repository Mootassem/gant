...
import TaxesFormModal from 'src/view/taxes/form/TaxesFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/taxes/taxesSelectors';

function TaxesAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return TaxesService.listAutocomplete(value, limit);
  };
...
export default TaxesAutocompleteFormItem;
