...
function TaxesToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    taxesSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    taxesSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="taxes-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="taxes-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="taxes-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="taxes-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=taxes">
          <span
