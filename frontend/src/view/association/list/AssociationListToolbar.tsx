...
function AssociationToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    associationSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    associationSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="association-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="association-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="association-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="association-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=association">
          <span
