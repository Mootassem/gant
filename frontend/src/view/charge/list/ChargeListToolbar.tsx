...
function ChargeToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    chargeSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    chargeSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="charge-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="charge-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="charge-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="charge-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=charge">
          <span
