...
import exporterFields from 'src/modules/objectif/list/objectifListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'OBJECTIF_LIST';

const objectifListActions = {
  ...
  doClearAllSelected() {
    return {
      type: objectifListActions.CLEAR_ALL_SELECTED,
    };
  },

  doToggleAllSelected() {
    return {
      type: objectifListActions.TOGGLE_ALL_SELECTED,
    };
  },

  doToggleOneSelected(id) {
    return {
      type: objectifListActions.TOGGLE_ONE_SELECTED,
      payload: id,
    };
  },
  ...
  doReset: () => async (dispatch) => {
    dispatch({
      type: objectifListActions.RESETED,
    });

    dispatch(objectifListActions.doFetch());
  },
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      dispatch({
        type: objectifListActions.EXPORT_STARTED,
      });
      ...
      dispatch({
        type: objectifListActions.EXPORT_ERROR,
      });
    }
  },
  ...
  doChangeSort: (sorter) => async (dispatch, getState) => {
    dispatch({
      type: objectifListActions.SORTER_CHANGED,
      payload: sorter,
    });
